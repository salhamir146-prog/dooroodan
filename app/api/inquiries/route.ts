...
export async function POST(request: Request) {
  try {
    ...
    // بررسی تکراری بودن (همین شماره در ۱۰ دقیقه اخیر)
...
// GET: دو حالت
// 1. بدون پارامتر: بررسی استعلام با ID
// 2. با phone: لیست استعلام‌ها
export async function GET(request: Request) {
  try {
    ...
    // حالت ۱: بررسی یه استعلام خاص با ID
    if (id) {
    ...
    // حالت ۲: لیست استعلام‌های یه شماره
    if (phone) {
